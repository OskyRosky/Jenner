...
```{r}
# Escenario D.1 — TMN 12.5 mm, deformación = 400 μɛ
...
# 2. Fórmula del modelo con variables permitidas
formula_12_400 <- log_ciclos ~ 
  pdf_rigidez_inicial_m_pa +
  pdf_energia_disipada_k_j_m3 +
  gbs_gmm +
...
mod_12_400_full <- lm(formula_12_400, data = df_12_400)

# 4. Tabla bonita de coeficientes en gt
