...
```{r}
# ==========================================
# 2. Ajuste del modelo mixto
#    (Mezcla = fijo, Bloque anidado = aleatorio)
# ==========================================
mod_vacios <- lmer(
...
anova_df |>
  gt() |>
  tab_header(
    title = md("**ANOVA — Efecto fijo de Mezcla**"),
