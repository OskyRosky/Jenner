...
donde:
	•	\mu = media global
	•	\alpha_i = efecto fijo de la mezcla i
	•	b_{j(i)} = efecto aleatorio del bloque j dentro de la mezcla i
	•	c_{k(ij)} = efecto aleatorio de la viga k dentro del bloque j y mezcla i
	•	\varepsilon_{ijk} = error residual
