...
- \(\texttt{gbs\_gmm}\), \(\texttt{gbs\_gmb}\),
- \(\texttt{pvm\_asfalto\_efectivo\_percent}\), \(\texttt{pvm\_asfalto\_sobre\_mac\_percent}\),
- \(\texttt{pvm\_vacios\_pv}\), \(\texttt{pvm\_gbs}\),
- \(\texttt{pvm\_vma\_percent}\), \(\texttt{pvm\_vfa\_percent}\), \(\texttt{pvm\_polvo\_asfalto}\),
- \(\texttt{pvm\_percent\_pasando\_1\_2}\), \(\texttt{pvm\_percent\_pasando\_number\_4}\),  
  \(\texttt{pvm\_percent\_pasando\_number\_8}\), \(\texttt{pvm\_percent\\_pasando\_number\_200}\).
