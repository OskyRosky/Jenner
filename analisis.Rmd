...
En conjunto, la exploración descriptiva respalda la calidad de la base de datos y justifica el uso de \log_{10}(\text{ciclos}) como respuesta, estableciendo un punto de partida sólido para la construcción de modelos de regresión específicos para cada combinación de TMN y nivel de deformación.
