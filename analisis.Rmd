...
\[
\widehat{\log_{10}(\text{Ciclos})} \;=\;
1222.5950
- 0.0001\,\text{pdf\_rigidez\_inicial\_m\_pa}
- 0.3369\,\text{pdf\_energia\_disipada\_k\_j\_m3}
- 586.4602\,\text{gbs\_gmm}
+ 0.2333\,\text{gbs\_percent\_vacios\_7\_1}
- 2.4589\,\text{pvm\_vma\_percent}
- 1.0302\,\text{pvm\_vfa\_percent}
+ 51.4099\,\text{pvm\_polvo\_asfalto}
+ 2.5250\,\text{pvm\_percent\_pasando\_1\_2}
\]
